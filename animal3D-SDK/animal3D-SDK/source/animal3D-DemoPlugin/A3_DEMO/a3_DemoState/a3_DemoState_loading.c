...
void a3demo_loadShaders(a3_DemoState *demoState)
{
	...
	union {
	...
	} shaderList = {
		{
			...
			// 02-shading
			{ { { 0 },	"shdr-fs:draw-tex",					a3shader_fragment,	1,{ A3_DEMO_FS"e/02-shading/e/drawTexture_fs4x.glsl" } } },
			{ { { 0 },	"shdr-fs:draw-Lambert-multi",		a3shader_fragment,	1,{ A3_DEMO_FS"e/02-shading/e/drawLambert_multi_fs4x.glsl" } } },
			{ { { 0 },	"shdr-fs:draw-Phong-multi",			a3shader_fragment,	1,{ A3_DEMO_FS"e/02-shading/e/drawPhong_multi_fs4x.glsl" } } },
			{ { { 0 },	"shdr-fs:draw-nonphoto-multi",		a3shader_fragment,	1,{ A3_DEMO_FS"e/02-shading/e/drawNonphoto_multi_fs4x.glsl" } } },
			// 03-framebuffer
